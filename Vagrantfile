...
Vagrant.configure(2) do |config|
    ...
    config.vm.synced_folder "..", "/home/docker/kimai", id: "kimai-dev" , type: "nfs"
    config.vm.synced_folder "~/.composer/", "/home/docker/.composer", id: "kimai-composer" , type: "nfs"
    ...
    # Bring up containers
    config.vm.provision "shell", run: "always", inline: "cd /home/docker/kimai/phpdocker && docker-compose up -d 1>&2"
