...
var workview_path = "../extensions/ki_workview/";

$(document).ready(function () {
    var workview_resizeTimer = null;

    $(window).bind('resize', function () {
        if (workview_resizeTimer) {
            clearTimeout(workview_resizeTimer);
        }
        workview_resizeTimer = setTimeout(workview_resize, 500);
    });
